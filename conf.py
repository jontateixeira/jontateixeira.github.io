...
BLOG_AUTHOR = "Jonathan C. Teixeira"  # (translatable)
BLOG_TITLE = "YHWH Dwells in my heart"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jontateixeira.github.io/"
...
# is in the manual.
COMMENT_SYSTEM_ID = "jontateixeira"
